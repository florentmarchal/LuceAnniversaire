...
!(function (t, e) {
                    ...
                    : "circle" === R || "ellipse" === R
                        ? ((h = "circle" === R ? (o = i = M.r) * L : ((o = M.rx), (i = M.ry) * L)),
                            (n =
                                ...
                                (a = M.cy) +
                                " C" +
                                [r + o, a + h, r + (l = o * L), a + i, r, a + i, r - l, a + i, r - o, a + h, r - o, a, r - o, a - h, r - l, a - i, r, a - i, r + l, a - i, r + o, a - h, r + o, a].join(",") +
                                "z"))
                        : "line" === R
                            ? (n = "M" + M.x1 + "," + M.y1 + " L" + M.x2 + "," + M.y2)
                            : ("polyline" !== R && "polygon" !== R) || ((n = "M" + (r = (u = (t.getAttribute("points") + "").match(T) || []).shift()) + "," + (a = u.shift()) + " L" + u.join(",")), "polygon" === R && (n += "," + r + "," + a + "z")),
    ...
    function measureSegment(t, e, n) {
        ...
        for (T.length = S.length = 0, a = e + 2; a < b; a += 6) {
            if (((o = t[a + 4] - M), (i = t[a + 2] - M), (s = t[a] - M), (u = t[a + 5] - R), (g = t[a + 3] - R), (f = t[a + 1] - R), (l = h = c = p = 0), H(o) < 0.01 && H(u) < 0.01 && H(s) + H(f) < 0.01))
                8 < t.length && (t.splice(a, 6), (a -= 6), (b -= 6));
            else
                for (r = 1; r <= w; r++)
                    (l = h - (h = ((m = P * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m)), (c = p - (p = (m * m * u + 3 * d * (m * g + d * f)) * m)), (y = $(c * c + l * l)) < C && (C = y), (N += y), (T[L++] = N);
            (M += o), (R += u);
        }
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < w; e++)
            if (((c = o), isNaN(m[e]) ? (i = (o = m[e].toUpperCase()) !== m[e]) : e--, (r = +m[e + 1]), (a = +m[e + 2]), i && ((r += y), (a += x)), e || ((l = r), (h = a)), "M" === o))
                s && (s.length < 8 ? --v.length : (P += s.length)), (y = l = r), (x = h = a), (s = [r, a]), v.push(s), (e += 2), (o = "L");
            ...
            else if ("L" === o || "Z" === o) "Z" === o && ((r = l), (a = h), (s.closed = !0)), ("L" === o || 0.5 < H(y - r) || 0.5 < H(x - a)) && (Cf(y, x, r, a), "L" === o && (e += 2)), (y = r), (x = a);
            else if ("A" === o) {
                if (
                    ((p = m[e + 4]),
                        (d = m[e + 5]),
                        ...
                        (g = m[e + 7]),
                        (n = 7),
                        1 < p.length && (p.length < 3 ? ((g = u), (u = d), n--) : ((g = d), (u = p.substr(2)), (n -= 2)), (d = p.charAt(1)), (p = p.charAt(0))),
    ...
    function pointsToSegment(t, e) {
        ...
        for (R && (t.push(x, w), (x = v), (w = y), (v = t[m - 2]), (y = t[m - 1]), t.unshift(v, y), (m += 4)), e = e || 0 === e ? +e : 1, a = 2; a < m; a += 2)
            (n = v),
                (r = y),
                (v = x),
                (y = w),
                ...
                ((o = b),
                    ...
                    (b = x - v),
                    (M = w - y),
                    (h = (((s = $(o * o + i * i)) + (l = $(b * b + M * M))) * e * 0.25) / $(Math.pow(b / l + o / s, 2) + Math.pow(M / l + i / s, 2))),
                    (f = v - ((u = v - (v - n) * (s ? h / s : 0)) + ((((g = v + (x - v) * (l ? h / l : 0)) - u) * ((3 * s) / (s + l) + 0.5)) / 4 || 0))),
                    (d = y - ((c = y - (y - r) * (s ? h / s : 0)) + ((((p = y + (w - y) * (l ? h / l : 0)) - c) * ((3 * s) / (s + l) + 0.5)) / 4 || 0))),
    ...
    function Z(t, e) {
        if (t.parentNode && (c || R(t))) {
            ...
            return (
                e &&
                (n
                    ? ((b = b || Z(t)), l.setAttribute("width", 0.01), l.setAttribute("height", 0.01), l.setAttribute("transform", "translate(" + o + "," + i + ")"), b.appendChild(l))
                    : (f || ((f = Z(t)).style.cssText = s), (l.style.cssText = s + "width:0.1px;height:0.1px;top:" + i + "px;left:" + o + "px"), f.appendChild(l))),
                l
            );
        }
    ...
    function aa(t, e) {
        ...
        if ((u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)), (n = l ? b : f), l))
                ...
                ? ((o =
                    -(a = (function _getCTM(t) {
                        var e,
                            n = t.getCTM();
                        return (
                            n || ((e = t.style[z]), (t.style[z] = "none"), t.appendChild(D), (n = D.getCTM()), t.removeChild(D), e ? (t.style[z] = e) : t.style.removeProperty(z.replace(/([A-Z])/g, "-$1").toLowerCase())), n || I.clone()
                        );
                    })(t)).e / a.a),
                    (i = -a.f / a.d),
                    (r = I))
            ...
            if (((o = i = 0), E)) for (r = t.offsetParent, a = t; (a = a && a.parentNode) && a !== r && a.parentNode;) 4 < (v.getComputedStyle(a)[z] + "").length && ((o = a.offsetLeft), (i = a.offsetTop), (a = 0));
    ...
    function qa(t, e, n, r, a, o, i, s, l) {
        return (
            (e = "cubic" === i.type ? [e] : (!1 !== i.fromCurrent && e.unshift(oa(n, r, s), a ? oa(n, a, l) : 0), i.relative && pa(e), [(a ? pointsToSegment : flatPointsToSegment)(e, i.curviness)])),
            (e = o(nt(e, n, i))),
            rt(t, n, r, e, "x", s),
            a && rt(t, n, a, e, "y", l),
    ...
    function ta(t, e, n) {
        var r,
            ...
            i = 0;
        return (
            "svg" === (t.tagName + "").toLowerCase() ? (r = t.viewBox.baseVal).width || (r = { width: +t.getAttribute("width"), height: +t.getAttribute("height") }) : (r = e && t.getBBox && t.getBBox()),
            e && "auto" !== e && ((o = e.push ? e[0] * (r ? r.width : t.offsetWidth || 0) : e.x), (i = e.push ? e[1] * (r ? r.height : t.offsetHeight || 0) : e.y)),
    ...
    function ua(t, e, n, r) {
        ...
        return (
            (i.e = i.f = 0),
            "auto" === r && e.getTotalLength && "path" === e.tagName.toLowerCase() && ((a = e.getAttribute("d").match(et) || []), (h += (a = i.apply({ x: +a[0], y: +a[1] })).x), (u += a.y)),
            ...
            return t && t.length
                ? (i &&
                    ("self" === i || (r = W(i)[0] || e) === e
                        ...
                        : (u && !1 !== u[2] ? j.set(e, { transformOrigin: 100 * u[0] + "% " + 100 * u[1] + "%" }) : (u = [oa(e, "xPercent") / -100, oa(e, "yPercent") / -100]),
            ...
            init: function init(t, e, n) {
                ...
                if (
                    ((this.rawPaths = o),
                        ...
                        (this.rotate = s || 0 === s) &&
                        ((this.rOffset = parseFloat(s) || 0), (this.radians = !!e.useRadians), (this.rProp = e.rotation || "rotation"), (this.rSet = t._gsap.set(t, this.rProp, this)), (this.ru = Q(t._gsap.get(t, this.rProp)) || 0)),
                        !Array.isArray(i) || "closed" in i || "number" == typeof f)
                )
                    cacheRawPathMeasurements((r = c(nt(getRawPath(e.path), t, e))), e.resolution), o.push(r), rt(this, t, e.x || "x", r, "x", e.unitX || "px"), rt(this, t, e.y || "y", r, "y", e.unitY || "px");
                else {
